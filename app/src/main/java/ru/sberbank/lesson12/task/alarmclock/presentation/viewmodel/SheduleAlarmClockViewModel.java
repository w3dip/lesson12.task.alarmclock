...
public class SheduleAlarmClockViewModel extends AndroidViewModel implements Callback<LiveData<AlarmClockItem>> {
    private LiveData<AlarmClockItem> clock;
    private AlarmClockRepository repository;

    public SheduleAlarmClockViewModel(@NonNull Application application) {
        super(application);
